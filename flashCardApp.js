...
function review(){
	...
	var oscarWinner = new flashCards.BasicCard('What movie won the Oscar for best picture at the 2016 Academy Awards?', 'Moonlight'); // would've thought La La Land if you tuned out right after the initial announcement.
